...
<html>
    ...
    <body>
        ...
        <div id="service-tittle-internet" >
            <h1 style="color:#999"><strong>Planos para internet</strong></h1>
        </div>
        <div class="container" style="padding-top: 5%; padding-bottom: 5%">
            ...
            <div id="basic-plan" class="row">
                <!-- começo linha 6 -->
                <div class="col-sm-6">
                    <!-- linha 1 da coluna tamanho 6-->
                    <img src="./img/icon_site.png" class="icon-plan" />
                    <div class="row container-fluid" >
                        <div class="pricing hover-effect">
                            <div class="pricing-head">
                                <h3>Basic PLAN <span>Site institucional</span></h3>
                                <h4><i>A partir de R$</i>500<i>.00</i></h4>
                            </div>
                        </div>
                    </div>
                    <!-- fim linha 1 da coluna tamanho 6-->
                    <!-- linha 1 da coluna tamanho 6-->
                    <div class="row container-fluid">
                        <div style="margin-top: -1.5%;">
                            <h1 style="color: #01a8e9 ;font-weight: bold; text-align:center">Divulgue sua empresa com um site institucional</h1>
                            <h3 style="color: #01a8e9;text-align:center">O que é um site institucional?</h3>
                ...
                <!-- fim da linha 6 -->    
                <div class="col-sm-6">
                    <img src="./img/icon-wordpress.png" class="icon-plan" />
                    <div class="col-md-12">
                        <div class="pricing hover-effect">
                            <div class="pricing-head">
                    ...
                    <div class="col-md-12"  style="margin-top: -1.5%;">
                        <h2 style="color: #01a8e9; font-weight: bold; text-align:center">Crie um site com algum mecânismo básico de interação com o cliente</h2>
                        <h3 style="color: #01a8e9; text-align:center">O que tem de diferente do BASIC PLAN?</h3>
            ...
            <div id="medium-plan" class="row">
                <div class="col-sm-8">
                    ...
                    <div class="row"  style="margin-top: -1.5%;">
                        <h2 style="color: #01a8e9; font-weight: bold; text-align: center">Tenha uma loja virtual que se encaixa com seu negócio</h2>
                        <h3 style="color: #01a8e9; text-align: center;">Loja baseada totalmente em seu estoque</h3>
                        <ul class="pricing-content list-unstyled">
                            <li>
                                <strong>Características:</strong>
                                <p> -PHP.</p> 
